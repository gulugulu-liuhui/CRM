<%@ page import="com.company.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.company.crm.workbench.domain.Tran" %>
...
<script type="text/javascript">
	...
	function changeIcon(stage, index1) {
		...
		//如果当前阶段的可能性为0，前7个一定都是黑圈，后两个一个是红叉，一个是黑叉
		...
		<%
			...
			if ("0".equals(currentPossibility)){
				...
				for (int i=0; i<dvList.size(); i++){
					...
					//如果遍历出来的阶段可能性为0，说明是后2个，一个是红叉，一个是黑叉
			...
			//如果当前阶段的可能性不为0，前7个有可能是绿圈、绿色标记、黑圈，后两个一定是黑叉
				...
				for (int i=0; i<dvList.size(); i++){
					...
					DicValue dv = dvList.get(i);
					String stage = dv.getValue();
					//String possibulity = pMap.get(stage);
					//如果遍历出来的阶段是当前阶段
